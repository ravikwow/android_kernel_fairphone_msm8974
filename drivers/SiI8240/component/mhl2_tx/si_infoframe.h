...
{
    unsigned char pixelRepetionFactor:4;
...
#else //)(
        unsigned char       HDMI_Video_Format:3; //HDMI_Video_Format_e
#endif //)
    }pb4;
    union
    {
...
#else //)(
            unsigned char   threeDStructure:4;  //ThreeDStructure_e
#endif //)
...
#define DumpIncomingInfoFrame(pData,length) DumpIncomingInfoFrameImpl((PInfoFrame_t)pData,length)
