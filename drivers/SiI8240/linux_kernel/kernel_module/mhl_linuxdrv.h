...
#define MHL_PART_NAME "sii,mhl-sii8240"	// WARNING! Must match I2C_BOARD_INFO() setting in board-omap3beagle.c
#define MHL_DRIVER_NAME "sii,mhl-sii8240"
/** ZTE_MODIFY niugang10089953 end **/
#define MHL_DRIVER_DESC "SiI-8240 MHL Tx Driver"
